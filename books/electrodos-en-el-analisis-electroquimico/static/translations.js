Documentation.addTranslations({
    ...
    "messages": {
        ...
        "Search finished, found %s page(s) matching the search query.": "Se encontraron las siguientes coincidencias:",
        "Search within %(docstitle)s": "Buscar en %(docstitle)",
        "Searching": "Buscando",
        "Searching for multiple words only shows matches that contain\n    all words.": "La b\u00fasqueda de varias palabras sólo muestra coincidencias que contienen\n    todas las palabras.",
        "Show Source": "Mostrar el c\u00f3digo",
        "Table of Contents": "Tabla de contenido",
        "This Page": "Esta p\u00e1gina",
        "Welcome! This is": "\u00a1Bienvenido! Este es",
        "Your search did not match any documents. Please make sure that all words are spelled correctly and that you've selected enough categories.": "No se encontraron coincidencias. Por favor, asegúrese de que todo esté correctamente escrito.",
